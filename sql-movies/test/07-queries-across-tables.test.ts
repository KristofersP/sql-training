...
describe("Queries Across Tables", () => {
  ...
  it(
    ...
    async done => {
      ...
      GROUP BY directors.full_name ORDER BY "total_budget" desc limit 3`;
  ...
  it(
    ...
    async done => {
      ...
      GROUP BY keywords.keyword ORDER BY "count" desc limit 10`;
      const result = await db.selectMultipleRows(query);
  ...
  it(
    ...
    async done => {
      const query = `SELECT movies.original_title, COUNT(*) as "count" from movies
  ...
  it(
    ...
    async done => {
      ...
      GROUP BY genres.genre ORDER BY "five_stars_count" desc limit 3
      `;
      const result = await db.selectMultipleRows(query);
  ...
  it(
    ...
    async done => {
      const query = `SELECT genres.genre, ROUND(AVG(movie_ratings.rating), 2) as "avg_rating" from genres
      JOIN movie_genres ON genres.id = movie_genres.genre_id
      JOIN movie_ratings ON movie_genres.movie_id = movie_ratings.movie_id
